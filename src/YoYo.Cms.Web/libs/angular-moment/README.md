...
```html
 @Html.IncludeScript(components/moment/moment.js"></script>
 @Html.IncludeScript(components/angular-moment/angular-moment.js"></script>
```
...
```html
 @Html.IncludeScript(components/moment/locale/de.js"></script>
```
