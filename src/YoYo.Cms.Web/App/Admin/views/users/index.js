    ...
    yoyocmsModule.controller('app.views.users.index', [
        ...
        function ($scope, $state, $uibModal, $stateParams, uiGridConstants, userService) {
            ...
            vm.getUsers = function () {
                vm.loading = true;
                userService.getPagedUsersAsync($.extend({ filterText: vm.filterText }, vm.requestParams))
            ...
            function openCreateOrEditUserModal(userId) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/Admin/views/users/createOrEditModal.cshtml',
